...
const abilityData=[
  ['01','특징','FEATURES','드물게 자연 발현하거나 태어날 때부터 발현되기도 한다.\n이능석을 사용하면 발현에 실패하지 않으며, 재능과 의지에 따라 이능이 결정된다.\n이능석으로 등급과 능력을 확인할 수 있다.\n수련으로 강해질 수 있지만 기본적인 발현 형태를 크게 벗어나지는 못한다.\n둘 이상의 계열이 결합된 복합 계열도 존재한다.'],
  ['02','등급','RANK','F — 정상적으로 발현되지 못한 실패작\nD — 거의 쓸모없는 이능\nC — 평범한 수준의 이능\nB — 평균 이상의 강력한 이능\nA — 압도적인 성능을 가진 강한 이능\nS — 상식을 초월한 최상위 이능'],
  ['03','계열','TYPE','원소 — 불, 얼음 등 자연의 힘\n신체 — 회복, 변형 등 신체와 관련된 힘\n정신 — 염력, 독심술 등 정신에 영향을 주는 힘\n특수 — 시간, 공간 등 기존 계열에 속하지 않는 힘']
];
